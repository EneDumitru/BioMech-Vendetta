...
namespace Invector.vCharacterController
{
    public class vHUDController : MonoBehaviour
    {
        ...
        public void Init(vThirdPersonController cc)
        {
            ...
            {
                ExperienceSystem.Instance.OnUpdateExp += UpdateExpSlider;
            }
            ...
            if (expSecondSlider && ExperienceSystem.Instance)
            {
                
                    expSecondSlider.onValueChanged.Invoke(expSecondSlider.value);
                
                expSecondSlider.value = ExperienceSystem.Instance.GetCurrentXpPercent();
            }
            if (staminaSlider)
            {
            ...
            if (staminaText)
            {
                staminaText.text = cc.currentStamina.ToString();
            }
        ...
        void UpdateSliders(vThirdPersonController cc)
        {
            ...
            // if (expSecondSlider != null && ExperienceSystem.Instance)
            //{
            //    if (cc.maxHealth != expSecondSlider.maxValue)
            //    {
            //        expSecondSlider.maxValue = Mathf.Lerp(expSecondSlider.maxValue, cc.maxHealth, healthSliderMaxValueSmooth * Time.fixedDeltaTime);
            //        expSecondSlider.onValueChanged.Invoke(expSecondSlider.value);
            //    }
            //    expSecondSlider.value = Mathf.Lerp(expSecondSlider.value, cc.currentHealth, healthSliderValueSmooth * Time.fixedDeltaTime);
            //}
            if (staminaSlider)
            {
                if (cc.maxStamina != staminaSlider.maxValue)
        ...
        private void UpdateExpSlider()
        {
            if (expSecondSlider)
            {
                ...
                expSecondSlider.DOValue(ExperienceSystem.Instance.GetCurrentXpPercent(), 0.5f);
            }
        }
        ...
        {
            levelText.text = experienceSystem.currentLevel.ToString();
        }
