...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonInput : vMonoBehaviour, vIAnimatorMoveReceiver
    {
        ...
        public virtual Camera cameraMain
        {
            get 
            {
                _cameraMain = tpCamera.targetCamera;
        ...
        private void Awake()
        {
            ...
            //hud = GetComponentInChildren<vHUDController>();
        }
        ...
        public virtual void FindHUD()
        {
            if (hud == null)
            {
                hud = gameObject.GetComponentInChildren<vHUDController>();
                hud.Init(cc);
            }
        }
        ...
        public virtual void StrafeInput()
        {
            ...
            //if (playerInput.actions["Strafe"].WasPressedThisFrame())
            //{
            //    Debug.Log("Strafe was pressed!");
            //    cc.Strafe();
            //}
        ...
        public virtual void SprintInput()
        {
            ...
            {
                cc.Sprint(cc.useContinuousSprint ? playerInput.actions["Sprint"].WasPressedThisFrame() : playerInput.actions["Sprint"].IsPressed());
        ...
        public virtual void CrouchInput()
        {
            ...
            if (crouchInput.useInput)
            {
                if (playerInput.actions["Crouch"].WasPressedThisFrame())
                    cc.Crouch();
                //else if (!useNewInput && crouchInput.GetButtonDown())
                //    cc.Crouch();
        ...
        {
            if (playerInput.actions["Jump"].WasPressedThisFrame() && JumpConditions())
            {
                cc.Jump(true);
            }
        ...
        {
            //if (playerInput.actions["Roll"].WasPressedThisFrame() && RollConditions())
            //{
            //    cc.Roll();
            //}
        ...
        public virtual void CameraInput()
        {
            ...
            var Y = lockCameraInput ? 0f : playerInput.actions["LookY"].ReadValue<float>();//rotateCameraYInput.GetAxis()
            var X = lockCameraInput ? 0f : playerInput.actions["LookX"].ReadValue<float>();//rotateCameraXInput.GetAxis()
        ...
        public virtual void UpdateHUD()
        {
            if (hud == null)
            {
                //if (gameObject.GetComponentInChildren<vHUDController>() != null)
                //{
                    hud = gameObject.GetComponentInChildren<vHUDController>();
                    hud.Init(cc);
                //}
