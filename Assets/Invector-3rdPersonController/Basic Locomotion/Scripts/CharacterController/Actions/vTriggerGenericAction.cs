...
namespace Invector.vCharacterController.vActions
{
    ...
    public class vTriggerGenericAction : vMonoBehaviour
    {
        ...
        [vHelpBox("Rotate Character to the Match point")]
        public bool useTriggerLookAt;
        ...
        public AnimationCurve matchLookAtCurve = new AnimationCurve(new Keyframe(0, 0), new Keyframe(.5f, 1), new Keyframe(1, 1));
