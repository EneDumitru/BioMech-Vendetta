...
namespace Invector.vCharacterController
{
    ...
    public class vMeleeCombatInput : vThirdPersonInput, vIMeleeFighter
    {
        ...
        public virtual void MeleeWeakAttackInput()
        {
            ...
            //if (playerInput.actions["Scope"].WasPressedThisFrame() && MeleeAttackStaminaConditions()) //weakAttackInput.GetButtonDown()
            //{
            //    TriggerWeakAttack();
            //}
        }
        ...
        public virtual void MeleeStrongAttackInput()
        {
            ...
            if (playerInput.actions["Shoot"].WasPressedThisFrame() && (!meleeManager.CurrentActiveAttackWeapon || meleeManager.CurrentActiveAttackWeapon.useStrongAttack) && MeleeAttackStaminaConditions())//strongAttackInput.GetButtonDown()
            {
                TriggerStrongAttack();
            }
        }
        ...
        public virtual void BlockingInput()
        {
            ...
            isBlocking = playerInput.actions["Aim"].IsPressed() && cc.currentStamina > 0 && !cc.customAction && !isAttacking;//blockInput.GetButton()
        }
        ...
        public override void SprintInput()
        {
            if (sprintInput.useInput)
            {
                ...
                bool canSprint = cc.useContinuousSprint ? playerInput.actions["Sprint"].WasPressedThisFrame() : playerInput.actions["Sprint"].IsPressed();
