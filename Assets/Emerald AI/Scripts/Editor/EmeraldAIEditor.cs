...
namespace EmeraldAI.Utility
{
    ...
    public class EmeraldAIEditor : Editor
    {
            ...
            if (TabNumberProp.intValue == 1)
            {
                ...
                if (TemperamentTabNumberProp.intValue == 2)
                {
                    ...
                    if (CombatTabNumberProp.intValue == 0)
                    {
                        ...
                        if (self.WeaponTypeRef == EmeraldAISystem.WeaponType.Melee)
                        {
                            CustomEditorProperties.CustomFloatSlider(new Rect(), new GUIContent(), MinMeleeAttackSpeedProp, "Min Melee Attack Speed", 0, 8);
                            ...
                            CustomEditorProperties.CustomFloatSlider(new Rect(), new GUIContent(), MaxMeleeAttackSpeedProp, "Max Melee Attack Speed", 0, 8);
                        ...
                        {
                            CustomEditorProperties.CustomFloatSlider(new Rect(), new GUIContent(), MinRangedAttackSpeedProp, "Min Ranged Attack Speed", 0, 8);
                            ...
                            CustomEditorProperties.CustomFloatSlider(new Rect(), new GUIContent(), MaxRangedAttackSpeedProp, "Max Ranged Attack Speed", 0, 8);
            ...
            if (TabNumberProp.intValue == 2)
            {
                ...
                if (DetectionTagsTabNumberProp.intValue == 0)
                {
                    ...
                    if (self.DetectionTypeRef == EmeraldAISystem.DetectionType.LineOfSight)
                    {
                        ...
                        CustomEditorProperties.CustomIntSlider(new Rect(), new GUIContent(), DetectionRadiusProp, "Detection Distance", 1, 1000);
        ...
        void DefaultCombatMovement()
        {
            ...
            {
                EditorGUILayout.BeginVertical("Box", GUILayout.Width(EditorGUIUtility.currentViewWidth - 40));
                CustomFloatAnimationField(new Rect(), new GUIContent(), CombatRunAnimationSpeedProp, "Run Speed", 0.5f, 10);
